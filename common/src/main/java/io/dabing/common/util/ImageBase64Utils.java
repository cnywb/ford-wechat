...
public class ImageBase64Utils {
    ...
    public final static void main(String[] aargs) throws Exception {
        String data = "data:image/png;base64,/9j/4AAQSkZJRgABAQEAYABgAAD/4RDYRXhpZgAATU0AKgAAAAgABQESAAMAAAABAAEAAAExAAIA";
        String result = ImageBase64Utils.base64Content(data);
        System.out.println(result);
    }

    public static String base64Content(String base64) {
        if (base64 == null) return "";
        return base64.replaceAll("^data:image\\/[a-zA-Z]+;base64,", "");
    }
