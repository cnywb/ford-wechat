...
public class QRCodeUtil {
    ...
    public static byte[] createImageByte(String content, boolean needCompress,int qrcodeSize) throws Exception {    
...
//        FileUtils.forceMkdir(destPath, false);  
        ImageIO.write(image, FORMAT_NAME, new File(destPath));    
    }    
    ...
    public static void main(String[] args) throws Exception {    
        ...
        QRCodeUtil.encode(text, "/Users/wen.huang/Pictures/logo_180x180.png", "C:/Users/wen.huang/Pictures/new/logo3.png", false,600);    
