 ...
 */
@Slf4j
@Service("couponSendDmsJobLauncher")
public class CouponSendDmsTimer {


    @Resource(name = "couponSendDmsJob")
    private Job job;
    ...
    public void execute() {
        ...
        List<BatchTask> list = this.batchTaskService.getByType(BatchType.COUPON_SEND_DMS);
