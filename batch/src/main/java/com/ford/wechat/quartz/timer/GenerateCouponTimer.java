 ...
 * @since 1.0
 */
@Service("generateCouponJobLauncher")
public class GenerateCouponTimer {
    ...
    @Resource(name = "generateCouponJob")
    private Job job;
    ...
    public void execute() {
        ...
        List<BatchTask> list = this.batchTaskService.getByType(BatchType.GENERATE_COUPON);
