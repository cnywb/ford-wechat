 ...
 * All rights reserved. 2017-03-23 21:00
 * </p>
 *
 * @author MaoJiaWei
 * @version 1.0
 */
@Service("authToDmsJobLauncher")
public class AuthToDmsTimer {
    /**
     * 日志
     */
    private static final Logger logger = LoggerFactory.getLogger(AuthToDmsTimer.class);

    @Resource(name="authToDmsJob")
    private Job job;
    ...
    public void execute() {
        ...
        List<BatchTask> list =this.batchTaskService.getByType(BatchType.AUTH_TO_DMS);
