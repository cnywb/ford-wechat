 ...
 * @version 1.0
 */
@Service("createEveryDayBatchTimer")
public class CreateEveryDayBatchTimer {
    ...
    public void execute() {
        //创建每日自动认证批次
        createBatchTask(BatchType.AUTO_AUTH);

    }

    private void createBatchTask(BatchType batchType){
        ...
        //批次备注
        String remark = DateUtil.formatDate(new Date(),DateUtil.FORMAT_DATETIME_DEFAULT)+"-"+batchType.getName();
