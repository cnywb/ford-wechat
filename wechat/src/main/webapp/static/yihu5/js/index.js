(function ($) {
    ...
    $.extend(Ford.prototype, {
        ...
        init: function(data) {
			this.imgurl = '/fordwechat/static/yihu5/'
			...
			''+this.imgurl+'img/part1_5.jpg',''+this.imgurl+'img/part1_6.jpg',''+this.imgurl+'img/part1_7.jpg',''+this.imgurl+'img/part2.jpg',''+this.imgurl+'img/part2_1.jpg',''+this.imgurl+'img/part2_2.jpg',''+this.imgurl+'img/part2_3.jpg',''+this.imgurl+'img/part2_4.jpg',''+this.imgurl+'img/part3.jpg',''+this.imgurl+'img/part4.jpg',''+this.imgurl+'img/part4_1.jpg',''+this.imgurl+'img/part4_2.jpg']);
		},
