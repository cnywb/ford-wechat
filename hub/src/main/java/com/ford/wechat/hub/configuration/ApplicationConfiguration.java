 ...
 */
package com.ford.wechat.hub.configuration;

import com.ford.wechat.hub.interceptor.AuthenticationInterceptor;
import com.ford.wechat.hub.interceptor.SessionInterceptor;
...
//        registry.addInterceptor(new AuthenticationInterceptor()).addPathPatterns("/hub/**").excludePathPatterns("/hub/hub/**");
    }
    @Bean
