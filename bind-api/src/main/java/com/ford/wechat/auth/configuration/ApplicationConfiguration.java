 ...
 */
package com.ford.wechat.auth.configuration;

import com.ford.wechat.auth.interceptor.AuthenticationInterceptor;
import com.ford.wechat.auth.interceptor.CrosAccessInterceptor;
import com.ford.wechat.auth.interceptor.SessionInterceptor;
...
//        registry.addInterceptor(new CrosAccessInterceptor());
        ...
        registry.addInterceptor(new AuthenticationInterceptor())
                .addPathPatterns("/i/**").excludePathPatterns("/public/**", "/i/login" ,"/i/member/**");
    }
    @Bean
