 ...
 * All rights reserved. 2017-07-17 16:43
 * </p>
 *
 * @author MaoJiaWei
 * @version 1.0
 */
@Repository
public class DmsRepairOrderRepositoryImpl extends DefaultJpaRepository<DmsRepairOrder, Long> implements DmsRepairOrderRepository {
     ...
     * @return 分页结果数据对象集合
     */
    public Page<DmsRepairOrder> pagingBy(GridPage page) {
        StringQuery query = StringQuery.newQuery()
                .query("from DmsRepairOrder where 1 = 1 ")
