...
package com.ford.wechat.pc.es.impl;
...
@Service
@Slf4j
public class ElasticSearchServiceImpl implements ElasticSearchService, InitializingBean ,DisposableBean {
    ...
    public void deleteQAInfoIndex(String indexId) {
        ...
        try {
            client = getClient();
//            client.prepareDelete(QAInfoEntityIndex, QAInfoType, indexId);
            DeleteRequest request = new DeleteRequest();
            request.id(indexId);
