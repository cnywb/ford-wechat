...
var dbResourceTreeDirectives = angular.module('db.components.areaTree', ['dbUtils']);

dbResourceTreeDirectives.dbResourceTreeCaches = {};//机构树数据缓存对象

dbResourceTreeDirectives.directive('dbAreaTree', ['dbUtils', function (dbUtils) {
        ...
        controller: ['$scope', '$modal', function ($scope, $modal) {
            ...
            function resourceTreeCtrl($scope, $modalInstance, field) {
                ...
                $scope.closeModal = function () {
                    ...
                    if(dbResourceTreeSettings.closeFunc){
                        dbResourceTreeSettings.closeFunc();
                    }
