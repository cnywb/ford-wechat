...
function ImCodeTypeEditorCtrl($scope, $modalInstance, imCodeType) {
    ...
    $scope.dbForm = {
        ...
        sections: [{
            ...
            fields: [
                {"name": "code", "label": "字典代码", "type": "text", "labelCols": "3", "editable": false, "required": true, "placeholder": "数据字典大类代码", "cols": "11"},
                {"name": "typeCode", "label": "大类类型",  "type": "select", dropDownItemType: "json", dropDownItem: "typeCode", "labelCols": "3", "editable": false, "required": true, "placeholder": "类型代码", "cols": "11"},
                {"name": "nameCn", "label": "中文名称", "type": "text", "labelCols": "3", "editable": false, "required": true, "placeholder": "中文名称", "cols": "11"},
                {"name": "nameEn", "label": "英文名称", "type": "text", "labelCols": "3", "editable": false, "required": true, "placeholder": "英文名称", "cols": "11"},
