...
function ImCodeListEditorCtrl($scope, $modalInstance, imCodeList) {
    ...
    //!!FORM--START!!
    $scope.dbForm = {
        settings: {showClose: true, transCode: angular.isUndefined(imCodeList) ? "1021" : "imCodeListModify", cols: 1},// false 新增页面，true 修改页面
        title: {icon: "luru", label: "字典数据项"},
        sections: [{
            sectionTitle: {show: true, icon: "shujuzidianguanli", label: "字典项信息"},
            fields: [
                {"name": "typeCode", "label": "字典大类", "type": "select", dropDownItemType: "imim", dropDownItem: "businessTm", "labelCols": "3", "editable": true, "required": true, "cols": "11"},
