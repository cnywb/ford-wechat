    ...
    var formGridOptions = {
        ...
        grid: {
            ...
            header: [
                ...
                {"name": "类型代码", "width": "10%", "field": "typeCode_"},
    ...
    var formGridEvents = {
        grid: {
            fieldEvents: {
                ...
                "typeCode_Format": function (value, currentRecord) {
                    if (currentRecord['typeCode'] == "businessTm") {
                        return "业务枚举";
                    } else if (currentRecord['typeCode'] == "global") {
                        return "全局枚举";
                    }
                }
            },
...
function ImCodeListCtrl($scope, $modal, dbUtils) {
    ...
    var formGridOptions = {
        form: {
            ...
            fields: [
                {"name": "keyWord", "label": "关键字", "type": "text", "placeholder": "名称/代码", "labelCols": "3"},
                {"name": "typeCode", "label": "字典大类", "type": "select", dropDownItemType: "imim", dropDownItem: "businessTm", "labelCols": "3"}
            ]
        },
        grid: {
            settings: {
