...
DBApp.controller("answerListCtr", ['$scope', '$modal', 'dbUtils','$http', function($scope, $modal, dbUtils,$http){
    ...
    var formGridOptions = {
        form: {
            ...
            fields: [
                ...
                {label: "答案时间", type: "dateRange", name:"answer", labelCols: "3"}
            ],
            hiddenParams: {status:2}
        },
        grid: {
            settings: {
